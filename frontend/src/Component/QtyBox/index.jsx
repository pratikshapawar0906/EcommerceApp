...
const QtyBox = () => {
  ...
  return (
    <>
      <div className="qtyBox flex item-center relative">
        <input type='Number' className=' w-full  h-[40px] p-2 pl-5 text-[15px] focus:outline-none   border-1 border-[rgba(0,0,0,0.1)]
