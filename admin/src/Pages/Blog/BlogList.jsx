...
const columns = [
  ...
  { id: 'blogTitle', label: 'Title', minWidth: 200 },
  { id: 'descripation', label: 'Descripation', minWidth: 200 },
...
const BlogList = () => {
    ...
    const deleteBlogImage=(id)=>{
         deleteData(`/api/blog/deleteImageSlider/${id}`).then((res)=>{
             fetchDataFromApi("/api/Blog/get").then((res)=>{
               setImages(res?.data || []);
             })
         })
  ...
  return (
    <>
       <div className="flex items-center justify-between px-2 py-0 mt-3">
        <h2 className="text-[18px] font-[700]"> Blogs List <span className='font-[400] text-[14px]'> </span></h2>
           ...
           <TableBody>
            {
                ...
                <TableCell width={200}>
                      <span className="text-[15px] font-[500]">{item?.blogTitle}</span>
                </TableCell>

                <TableCell width={300}>
                      <div  dangerouslySetInnerHTML={{    __html: item?.descripation?.substr(0, 150) + '....'  }}/>
                </TableCell>
                ...
                <TableCell width={100}>
                    <div className="flex items-center gap-1">
                        ...
                        <TooltipMUI title="Remove Product" placement="top">
                            <Button className='!w-[35px] !h-[35px]  bg-[#f1f1f1] !border !border-[rgba(0,0,0,0.1)] !rounded-full hover:!bg-[#f1f1f1]' style={{minWidth:'35px'}}
                             onClick={()=>deleteBlogImage(item?._id)}>
