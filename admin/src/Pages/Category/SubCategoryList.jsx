...
const columns = [
  ...
  { id: 'Category Image', label: 'CATEGORY IMAGE', minWidth: 250 },
   { id: 'Category Name', label: 'CATEGORY NAME', minWidth: 250 },
   { id: 'SubCategory Name', label: 'SUB CATEGORY NAME', minWidth: 400 },
  ...
  return (
    <>
       <div className="flex items-center justify-between px-2 py-0 mt-3">
        <h2 className="text-[18px] font-[700]">Sub Category List <span className='font-[400] text-[14px]'> ( Material UI Table)</span></h2>
